...
public class BasicProperties {
    // 用户信用等级
            public static  final  String[]  Basic_UserLevel_paramName ={"id",   "level",    "protocolType","effectiveness"};
            public static  final  String[]  Basic_UserLevel_paramVal  ={"序列号","信用等级","协议类型",    "是否有效"};
    // 层级位数
    ...
    //合作伙伴
           ...
           /*海外代理*/
            ...
            public static final String Basic_PartnerDeta_paramVal  [] = {"名称",    "ID","代码",  "助记码",
                    ...
                    /*互为代理*/
                    "进项税票","进项税率%","信用等级","开票类型","信用期限类型","代垫","代垫期限(天)","代垫额度(万元)","信用期限(天)","信用额度(万元)","开户银行","银行账号","公司地址","公司电话",
               /*海外代理*/
