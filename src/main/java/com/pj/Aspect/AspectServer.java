...
public class AspectServer {
    ...
    public void editPostAuthorityPointcutAfter(JoinPoint point) throws NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
        ...
        if (null != authMenuList && null != oldAuthority) {
            ...
            for (AuthMenu button : oldIsmenu) {
                for (AuthMenu dat : oldIsmenu) {
                    actionData += dat.getName() + ";";
                    if (button.getIsMenu() == 1) {
                        if (button.getPId().equals(dat.getId())) {
        ...
        public void PartnerDetailsServiceImplInsertSelectiveAfter (JoinPoint point) throws
        NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
            String actionData = "";
            Object[] args = point.getArgs();
            HttpServletRequest request = requestinit();
        ...
        public void PartnerDetailsServiceImplDeletePartnerDetailsByIdBefore (JoinPoint point) throws
        NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
            HttpServletRequest request = requestinit();
            Object[] args = point.getArgs();
            // 获取将要删除的合作伙伴人信息
        ...
        public void PartnerDetailsServiceImplDeletePartnerDetailsByIdAfter (JoinPoint point) throws
        NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
            String actionData = "";
            Object[] args = point.getArgs();
            HttpServletRequest request = requestinit();
        ...
        public void PartnerDetailsServiceImplUpdateByPrimaryKeyAfter (JoinPoint point) throws
        NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
            // 数组设定
            String actionData = "";
            Object[] args = point.getArgs();
        ...
        public void PartnerAddressServiceImplInsertAfter (JoinPoint point) throws
        NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
            String actionData = "";
            Object[] args = point.getArgs();
            ServletRequestAttributes attributes = RequestDate.requestInit();
        ...
        public void PartnerLinkmanServiceImplDeleteListAfter (JoinPoint point) throws
        NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
            String actionData = "";
            ServletRequestAttributes attributes = RequestDate.requestInit();
            HttpServletRequest request = attributes.getRequest();
        ...
        public void updateHierarchyListexecutionAfter (JoinPoint point) throws
        NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
            String actionData = "";
            Object[] args = point.getArgs();
        ...
        public void updateLevelByIdAfter (JoinPoint point) throws
        NoSuchFieldException, IllegalAccessException, IntrospectionException, InvocationTargetException {
            // 数组设定
            String actionData = "";
            HttpServletRequest request = requestinit();
